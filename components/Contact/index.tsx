...
export default function Contact(): JSX.Element {
  ...
  return (
    <Section id={"contact"} title={"Contact"}>
      <div className="tablet:py-5 bg-slate-600 ">
        <div className={"grid tablet:grid-cols-2 grid-cols-1 h-[90vh]"}>
          <div className="flex-col flex justify-center tablet:border-r-2">
            {ContactOptions.map(
              (contactOption: ContactOptionModel): JSX.Element => {
                return (
                  <div className={"flex-row bg-slate-800 rounded-lg my-3 tablet:mx-8 mx-3"}>
           ...
           >
             <div
                 className={
                   "h-full bg-slate-800 tablet:w-3/4 tablet:h-3/4 rounded-lg shadow-xl shadow-slate-50/50 border-2 focus:outline-none focus:border-brand duration-300"
                 }
             >
               <div className={"flex-col h-full flex justify-evenly"}>
                 ...
                 <div className={"flex justify-center w-full tablet:pt-16 pt-6 pb-2"}>
                   <button
                       type="submit"
                       className={
                         "btn-sm rounded-lg btn-primary bg-brand duration-500 hover:bg-green-300 tablet:px-8 tablet:py-3 tablet:text-lg font-semibold flex items-center justify-center text-xs tablet:mt-0 mt-6 border-0 hover:-translate-y-2"
                       }
                   >
                     {isLoading ? (
                         <>

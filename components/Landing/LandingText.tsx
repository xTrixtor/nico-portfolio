...
function LandingText() {
  ...
  return (
    <div ref={myRef}>
      ...
      >
        <div className={"container py-5 z-20 text-center tablet:text-start"}>
          <Row className="flex tablet:justify-start justify-center tablet:text-7xl text-2xl text-slate-200 font-semibold">
            Hi! I am Nico.
          </Row>
          <Row className="flex tablet:justify-start justify-center tablet:text-7xl text-2xl">
            <div>
              <p className="text-brand font-black">A software developer</p>
